...
interface StepIneligibleCollegeProps {
  onNext?: () => void;
}

export function StepIneligibleCollege({ onNext }: StepIneligibleCollegeProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-start w-full h-full text-center px-4">
      ...
      <p className="m-0 mt-4 text-base text-[#EAEAEA] max-w-[90%] leading-relaxed">
        We’re starting with high school athletes, but will be opening to college
        athletes very soon. Add your number so you’re first in line.
      </p>
